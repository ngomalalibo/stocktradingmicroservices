...
import com.stocktrading.authservice.codec.IDPrefixCodec;
import com.stocktrading.authservice.entity.ActivityLog;
...
//        MongoIterable<String> colls = dataService.listCollectionNames();
    ...
    public MongoCollection getCollectionFromEntityName(String entityName)
    {
        ...
        return this.mapCollectionsAndEntities().get(entityName);
    }
