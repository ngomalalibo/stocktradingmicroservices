package com.stocktrading.authservice.repository;
...
import com.stocktrading.authservice.database.DatabaseConnection;
import com.stocktrading.authservice.database.MongoConnectionImpl;
import com.stocktrading.authservice.dataprovider.GetObjectByIDorEmail;
import com.stocktrading.authservice.dataprovider.SortProperties;
...
import com.stocktrading.authservice.util.AppConstants;
import com.stocktrading.authservice.util.CustomNullChecker;
import com.stocktrading.authservice.util.GetEntityNamesFromPackage;
            ...
            entities.forEach(ent ->
                             {
                                 if (ent.equals(name))
                                 {
                                     collection = (MongoCollection) databaseConnection.getCollectionFromEntityName(name);
...
//            log.info("value -> " + value);
                                       ...
                                       d.iterator().forEachRemaining(mr ->
                                                                     {
                                                                         try
                                                                         {
                                                                             ...
                                                                             Optional.of((S) ((MongoCollection) databaseConnection.getCollectionFromEntityName(subEntity))
                                   ...
                                   g.forEachRemaining(searchResultItem ->
                                                      {
                                                          ...
                                                          MongoCollection collection = (MongoCollection) databaseConnection.getCollectionFromEntityName(foreignEntity);
    ...
    public <B extends PersistingBaseEntity, S extends PersistingBaseEntity> Map<B, List<S>> getOneEntityFromJoinById(String name, String foreignId, String value, String foreignEntity, String filterOne, String filterTwo, String bean, String primaryId)
    {
        if (!isCollectionNullorEmpty())
        {
            ...
            B objectById = (B) GetObjectByIDorEmail.getObjectById(primaryId, (MongoCollection) databaseConnection.getCollectionFromEntityName(bean));
