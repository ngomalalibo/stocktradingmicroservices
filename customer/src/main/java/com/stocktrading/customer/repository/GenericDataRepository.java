...
import com.stocktrading.customer.dataprovider.GetObjectByID;
import com.stocktrading.customer.dataprovider.SortProperties;
import com.stocktrading.customer.entity.PersistingBaseEntity;
import com.stocktrading.customer.exception.CustomNullPointerException;
import com.stocktrading.customer.util.AppConstants;
import com.stocktrading.customer.util.CustomNullChecker;
import com.stocktrading.customer.util.GetEntityNamesFromPackage;
...
//            log.info("value -> " + value);
    ...
    public <B extends PersistingBaseEntity, S extends PersistingBaseEntity> Map<B, List<S>> getOneEntityFromJoinById(String name, String foreignId, String value, String foreignEntity, String filterOne, String filterTwo, String bean, String primaryId)
    {
        if (!isCollectionNullorEmpty())
        {
            ...
            B objectById = (B) GetObjectByID.getObjectById(primaryId, (MongoCollection) databaseConnection.getCollectionFromEntityName(bean));
